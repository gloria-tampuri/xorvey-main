...
//       url = `https://pakyi-w1wnypb2.b4a.run/add/secretary`;

//     } else if(role === "Inspector") {
//       // url = `${import.meta.env.VITE_APP_API_URL}add/inspector`;
//       url = `https://pakyi-w1wnypb2.b4a.run/add/inspector`;
...
const AddOfficers = () => {
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.error("Error making request:", error);
      alert("Make sure email or phone number doesn't already exist");
    } finally {
      hideAddOfficer();
    }
  };
  ...
  return (
    <Modal>
      ...
      <form className={styles.forms} onSubmit={handleFormSubmit}>
        ...
        <div className={styles.buttons}>
          <button className={styles.cancel} type="button" onClick={hideAddOfficer}>
            Cancel
          </button>
