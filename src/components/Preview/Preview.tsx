  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const applicant = forms.find((form:any) => form.uniqueFormID === uniqueFormID);
  ...
  return (
    <div className={styles.preview}>
      ...
      {showTrack ? (
       ...
       application && <div className={styles.info}>
          ...
          <div className={styles.appli}>
            ...
            <p>{application.applicantName || application.organisationName}</p>
              <p>{application.applicantDOB[0]}</p>
            </div>
          </div>
          <div className={styles.appli}>
            <div className={styles.subheaders2}>
