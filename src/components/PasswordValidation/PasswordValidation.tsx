import card from './PasswordValidation.module.css'
const PasswordValidation = () => {
    return (
        <>
            <div className={card.requiredWrapper}>
                <h4 className={card.cardHeader}>Your password must contain:</h4>
                <div className={card.card}>
                    ...
                    <span className={card.cardText}>At least 8 Characters</span>
                </div>
                <div className={card.card}>
                    <svg
                        width="14"
                ...
                <div className={card.card}>
                    ...
                    <span className={card.cardText}>Numbers (0-9)</span>
                </div>
                <div className={card.card}>
                    <svg
                        width="14"
                    ...
                    <span className={card.cardText}>Symbol (@-!)</span>
                </div>
            </div>
        </>
    )
