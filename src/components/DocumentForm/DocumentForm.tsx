...
//       // Store updated basicInfo in local storage
...
//                 <div className={styles.section}>
//                   <label htmlFor="photographicID">Photographic ID card*</label>
//                   <div className={styles.example}>
//                   <p>No file chosen</p>
...
//                     />
//                     <label htmlFor="passportPhoto">Upload</label>
//                   </div>
//                 </div>
//               </div>
    ...
    <div>
      ...
      <div className={styles.all}>
        <div className={styles.basicForm}>
          <div className={styles.head}>
            <h3>Documents Upload</h3>
            <p>Please Upload the Following Documents for Application Processing</p>
          </div>
          <div className={styles.form}>
            <form>
              <div className={styles.left}>
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.example}>
                    ...
                    <input
                      ...
                      onChange={(e) => handleFileChange(e, setPhotographicID)}
                    />
                    <label htmlFor="photographicID">Upload</label>
                  </div>
                </div>
                <div className={styles.section}>
                  <label htmlFor="passportPhoto">Passport photo*</label>
